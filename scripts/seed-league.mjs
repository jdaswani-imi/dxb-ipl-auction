...
const TEAMS = [
  ...
  { name: "Mirza's Menaces PK",   owner_email: "alizaky@gmail.com" },
...
const SQUADS = {
  ...
  "ARM XI": [
    ...
    ["Josh Hazlewood","RCB",5],["Dewald Brevis","CSK",20],["Noor Ahmad","CSK",15],
    ["Corbin Bosch","MI",1],["Rashid Khan","GT",13],
  ],
  ...
  "Jhurani Giants": [
    ...
    ["Shardul Thakur","MI",1.5],["David Miller","DC",8],["Ayush Badoni","LSG",9],
    ["Bhuvneshwar Kumar","RCB",7.5],["Sherfane Rutherford","MI",5.5],["Jason Holder","GT",5.5],
  ],
  "Kazzatax Abhimeow": [
    ...
    ["Sameer Rizvi","DC",9.5],["Marco Jansen","PBKS",16],["Auqib Nabi","DC",11],
  ],
  "Mirza's Menaces PK": [
    ...
    ["Rishabh Pant","LSG",21],["Prasidh Krishna","GT",11],["Rahul Tewatia","GT",1],
    ["Anshul Kamboj","CSK",2.5],["Suryakumar Yadav","MI",25],["Abdul Samad","LSG",0.5],
    ["Cameron Green","KKR",8.5],["Shivam Dube","CSK",8.5],["Jos Buttler","GT",16],
  ],
  "Moizzy's Ravers": [
    ...
    ["Khaleel Ahmed","CSK",12],["Aiden Markram","LSG",20],["Deepak Chahar","MI",5],
    ["Suyash Sharma","RCB",8],["Sai Sudharsan","GT",25],["Kartik Sharma","CSK",5],
  ],
  "Nig8 XI": [
  ...
  "Super Capitals": [
    ...
    ["KL Rahul","DC",21],["Devdutt Padikkal","RCB",8],["Nitish Rana","DC",7.5],
    ["Avesh Khan","LSG",3.5],["Liam Livingstone","SRH",7.5],["Tim David","RCB",9.5],
    ["Akash Madhwal","CSK",15],["Digvesh Rathi","LSG",5],["Dhruv Jurel","RR",8.5],
    ["Blessing Muzarabani","KKR",6.5],["Pathum Nissanka","DC",5],["Akeal Hosein","CSK",2.5],
  ],
  "Turd XI": [
